...
| 工具 | 版本 | 授權 | 維護者 | 資料外傳 |
|------|------|------|--------|---------|
| actions/checkout | @v6 | MIT | GitHub 官方（Node 24） | 無 |
| actions/setup-go | @v6 | MIT | GitHub 官方（Node 24） | 無 |
| actions/upload-artifact | @v7 | MIT | GitHub 官方（Node 24） | 無（GitHub 內部） |
| actions/download-artifact | @v7 | MIT | GitHub 官方（Node 24） | 無 |
